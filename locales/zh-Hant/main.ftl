download_command = 從多種來源上下載小說
search_command = 從多種來源上搜索小說
info_command = 顯示多種來源的小說信息
read_command = 閱讀多種來源的小說
bookshelf_command = 顯示多種來源的收藏夾小說
transform_command = 轉換 pandoc 風格的 markdown 文件
check_command = 檢查 pandoc 風格的 markdown 文件的格式和內容
...
keyword = 搜索小說使用的關鍵詞
limit = 搜索結果的最大數量
show_categories = 顯示多種來源上所有類別名稱
show_tags = 顯示多種來源上所有標籤名稱
