download_command = Download novel from various sources
search_command = Search novel from various sources
info_command = Show novel information from various sources
read_command = Read novel from various sources
bookshelf_command = Show favorite novel from various sources
...
show_categories = Show category from various sources
show_tags = Show tags from various sources
