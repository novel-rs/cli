download_command = 从多种来源上下载小说
search_command = 从多种来源上搜索小说
info_command = 显示多种来源的小说信息
read_command = 阅读多种来源的小说
bookshelf_command = 显示多种来源的收藏夹小说
...
keyword = 搜索小说使用的关键词
limit = 搜索结果的最大数量
show_categories = 显示多种来源上所有类别名称
show_tags = 显示多种来源上所有标签名称
